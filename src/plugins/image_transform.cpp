...
namespace uniconv::plugins
{
    ...
    core::PluginInfo ImageTransformPlugin::info() const
    {
        ...
        // Data types
        info.input_types = {core::DataType::Image, core::DataType::File};
        info.output_types = {core::DataType::Image};
    ...
    core::Result ImageTransformPlugin::execute(const core::Request &request)
    {
#ifndef UNICONV_HAS_VIPS
    ...
    ImageTransformPlugin::ImageOptions ImageTransformPlugin::parse_plugin_options(
        const std::vector<std::string> &plugin_options) const
    {
        ImageOptions opts;
    ...
    core::Result ImageTransformPlugin::convert_image(
    ...
    std::filesystem::path ImageTransformPlugin::determine_output_path(
        ...
        const std::optional<std::filesystem::path> &output_option) const
    {
        if (output_option)
        {
